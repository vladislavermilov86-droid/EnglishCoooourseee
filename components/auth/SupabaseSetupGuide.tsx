...
const fullSetupSql_v23 = `
-- EnglishCourse: ПОЛНЫЙ СКРИПТ v23 -- СТРУКТУРА, ПРАВА И ПОЛЬЗОВАТЕЛИ
-- ВНИМАНИЕ: Этот скрипт полностью пересоздаст структуру БД и создаст 3-х пользователей.
...
-- ШАГ 8: Создание пользователей (Ученики и Учитель) ИСПРАВЛЕННАЯ ВЕРСИЯ
...
SELECT 'Supabase full setup script v23 completed successfully!';
`;
            ...
            <div className="max-w-4xl mx-auto p-4 sm:p-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 sm:p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <p className="mb-2">
                           This SQL script will set up all the necessary tables, relationships, and security policies for the application to function correctly. It also pre-populates the database with a teacher and two student accounts for easy testing.
                        </p>
                        ...
                        <CodeBlock lang="sql">{fullSetupSql_v23.trim()}</CodeBlock>
                    </div>
